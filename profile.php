...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('.rate_address').click(function(){
			var user_id=$(this).data('id'); 
			//alert(user_id);
			//var address_id=$('#address_id');
			$('#address_id').val(user_id);
			//console.log(data);
		});
		...
		$('#address-form').submit(function(){
			...
			$.ajax({
				...
				type:'POST',
				data:{'address_id':address_id,'work_address':work_address,'home_address':home_address},
				success:function(data){
					//alert(data);	
					console.log(data);				
					data=JSON.parse(data);
		...
		<div class="row mt-3">
			<div class="col-md-3 mt-2">			
				<div class="card" id="profile">
				  ...
				  <div class="card-body">
				    <h5 class="card-title" style="color: crimson"><?php echo $_SESSION['name']; ?></h5>
				  </div>
				  <ul class="list-group list-group-flush">
				  	<?php
				  		$user_id=$_SESSION['user_id'];
				    	$query4="SELECT * FROM orders o JOIN restaurants r ON r.r_id=o.r_id WHERE o.user_id=$user_id AND o.status=1";
						...
						echo '<li class="list-group-item" style="color: magenta">Orders<span class="float-right">30</span></li>
						    <li class="list-group-item" style="color: magenta">Reviews<span class="float-right">30</span></li>
				  ...
				  <div class="card-body">
				    ...
				    <a href="index.php" class="btn btn-danger btn-block"> <i>Order Now!</i></a>
				  </div>				
				</div>				
			</div>
			<div class="col-md-6">
						...
						echo '<div class="col-md-12">
								<div class="card mt-2">
									<div class="card-body">
										...
										<p>Order Date: <b>'.$row['order_time'].'</b><span class="float-right" style="color: #ff0040">Total: Rs <b>'.$row['amount'].'</b></span></p>
										<table class="table">';
										...
										{
											echo '<tr>
													<td style="color: #0040ff">'.$row2['name'].'</td>
													<td style="color: #709d00">2 pcs</td>
												</tr>';
										}									
										echo '</table>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card" style="height: 300px;overflow-y: scroll;">
							<div class="card-body">
								<div>
									<h4 style="color:  orangered"><b><ul>Reviews</b></ul></h4>		
									<p>
											<?php
											$conn=mysqli_connect("localhost","root","","zomato1");
											$user_id=$_SESSION['user_id'];
											$query3="SELECT * FROM restaurants r JOIN orders o ON r.r_id=o.r_id  WHERE o.user_id='$user_id' AND o.status=1";					
											$result3=mysqli_query($conn,$query3);					
											$counter=0;
											while($row3=mysqli_fetch_array($result3))
											{				
												echo '<tr>
													<td><b>'. $row3['r_name'] .'</b></td><br>
													<td><small>'. $row3['order_time'].'</small></td><br>		
													<td>'.$row3['review'].'</td><hr>			
													</tr>';			
														$counter++;			
											}	
												//echo 
						...
						<div class="card" style="height: 200px;overflow-y: scroll;">
							<div class="card-body">
								<?php
									...
									$work_address=$result5['work_address'];
									$home_address=$result5['home_address'];
									echo '<h5 class="mt-1" style="color: orangered"><b><ul>Address:</b></ul> </h5>
									 <button data-toggle="modal" data-target="#addressModal" class="btn btn-danger btn-block mt-2 rate_address" data-id="'.$result5['user_id'].'">Add/Update</button>
									<div>
										<small class="badge badge-danger">Work</small>						
										<p>'.$result5['work_address'].'</p>				
									</div><hr>
									<div>
										<small class="badge badge-danger">Home</small>
										<p>'.$result5['home_address'].'</p>
									</div><hr>';
									?>									
							</div>
						</div>
	   		 ...
	   		 <div class="modal-content">
	    			 <div class="modal-header">
	     			 ...
	     			 <div class="modal-body">
			        	...
			        	<input id="work_address" type="text" name="work_address" class="form-control" value=""><br>
			        	<label>Home address</label><br>
			        	<input id="home_address" type="text" name="home_address" class="form-control" value=""><br>
			        	<input type="hidden" name="" id="address_id">
			        	<input type="submit" name="" value="submit" class="btn btn-danger">
			        	</form>
	     			 </div>
	   			 </div>
