...
<body class="bg-danger">
	...
	<div class="container">
		<div class="row mt-50" >
			<div class="col-md-8">
				<h1 class="text-light display-2 text-md-center">Craving for food? Look nowhere else. Explore Now.</h1>
			</div>
			<div class="col-md-4">
				<div class="card">
					<div class="card-body">						
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form>
	        	...
	        	<input type="text" name="" class="form-control"><br><br>
	        	<label>Restaurant Email:</label><br>
	        	<input type="Email" name="" class="form-control"><br><br>
	        	<label>Password:</label><br>
	        	<input type="Password" name="" class="form-control"><br><br>
	        </form>
	      </div>
	      <div class="modal-footer">
	        <button type="button" class="btn bg-danger text-light">Sign Up</button>
