...
$query="SELECT * FROM orders WHERE r_id=3 AND status=1";
...
$query3="UPDATE restaurants SET r_rating=$rating,r_num_ratings=$counter WHERE r_id=3";
try{
...
<body>
	<nav class="navbar bg-danger">
		<h4 class="navbar-brand text-light"><b>Zomato Admin</b></h4>
	...
	<div class="container">
		...
		<div class="row mt-3">
			<div class="col-md-6">
				<div class="card">
					<div class="card-body">
						<h2 style="color: #0040ff">Menu<button class="float-right btn btn-danger btn-sm" >Add Menu</button></h2>
						<table class="table">
							<tr>
								<th>S No.</th>
								<th>Name</th>
							...
							<?php
							$conn=mysqli_connect("localhost","root","","zomato1");
							$query1="SELECT * FROM menu WHERE r_id=3";
							...
							while($row1=mysqli_fetch_array($result1))
							{
								if($row1['status']==1)
								{
									echo '<tr >
										<td >'.$counter1.'</td>
										<td style="color: #ff0040"><i>'.$row1['name'].'</i></td>
										<td>
			...
			<div class="col-md-6">
				<div class="card">
					<div class="card-body">
						<h2 style="color: #0040ff">Recent Orders</h2>
						<table class="table">
							<tr>
								<th>S No.</th>
								<th>Order ID </th>
							...
							<?php
							$conn=mysqli_connect("localhost","root","","zomato1");
							$query2="SELECT * FROM orders o JOIN users u ON u.user_id=o.user_id WHERE r_id=3 AND delivery_status=0";
							...
							while($row2=mysqli_fetch_array($result2))
							{
								echo '<tr>
										<td>'.$counter2.'</td>
										<td class="order_id"><a href="#" data-toggle="modal" data-target="#orderModal">'.$row2['order_id'].'</a></td>
										<td style="color: #FF00FF" >'.$row2['name'].'</td>
										<td style="color: crimson" ><b>Rs '.$row2['amount'].'</b></td>
									</tr>';
								$counter2++;
							}
							?>
	 	...
	 	<div class="modal-dialog" role="document">
	   		 <div class="modal-content">
	    			 <div class="modal-header">
	       				 <h5 class="modal-title" id="exampleModalLabel" style="color: mediumblue" >Order Details</h5>
