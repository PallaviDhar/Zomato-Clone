...
<body>
	...
	<div class="jumbotron">
		<h1 class="display-1 text-md-center" style="color: blue">Hungry? Order Now! </h1>
		<h4 class="lead text-md-center" style="color: purple"><b>25 restaurants delivering now! </b></h4>
	</div>
	<div class="container">
		<h4 style="color: orangered"><b>Order food online in Kolkata</b></h4>
		<div class="row">
			<div class="col-md-2">
				<div class="card mt-2">
					<div class="card-body">
						<h4 style="color: #8000ff">Filter</h4>
						<input type="checkbox" name="" >Zomato Golden Partner<br><br>
						<h5 style="color: magenta"> Quick Filter</h5>
						<input type="checkbox" name="" >Online Payments<br>
						<input type="checkbox" name="">Non-veg<br>
						<input type="checkbox" name="">Pure-veg<br><br>
						<h5 style="color: deepskyblue">Sort-By</h5>
						<input type="checkbox" name="" >Populatity<br>
					</div>
				</div>
			</div>
			<div class="col-md-10">
