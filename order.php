...
<style type="text/css">
  ...
  background-filter: blur(8px);
	...
	.navbar-bg{
	background: #cb2d3e;  /* fallback for old 

browsers */
background: -webkit-linear-gradient(to right, 

#ef473a, #cb2d3e);  /* Chrome 10-25, Safari 5.1-6 */
background: linear-gradient(to right, #ef473a, 

#cb2d3e); /* W3C, IE 10+/ Edge, Firefox 16+, 
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#place').click(function(){
			window.location.href="http://localhost/zomato1/order_details.php?order_id=" + order_id;
		})
	})
</script>
			...
			<div class="col-md-4">
				<div class="row">
					...
					<div class="col-md-12 ">
						<div class="card">
							<div class="card-body">
								<h3 style="color: blue"><i>Address</i></h3>
					...
					<div class="col-md-12 mt-3">
						<div class="card">
							<div class="card-body">
								<h3 style="color: blue"><i>Contact us:</i></h3>
								<p><b style="color: deeppink">Email:</b> <a><?php echo $r_mail; ?></a></p>
								<p><b style="color: deeppink">Call us:</b> <?php echo $r_phn; ?></p>
							</div>
						</div>
					</div>
				</div>
